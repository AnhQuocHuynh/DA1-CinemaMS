...
public class CreateTemplateCommandValidatorTests
{
    ...
    {
        // Arrange
        var command = new CreateTemplateCommand("CODE", NotificationChannel.EMAIL, "Subject", "Body");
    ...
    {
        // Arrange
        var command = new CreateTemplateCommand(invalidCode!, NotificationChannel.EMAIL, "Subject", "Body");
    ...
    {
        // Arrange
        var command = new CreateTemplateCommand("CODE", NotificationChannel.EMAIL, invalidSubject!, "Body");
    ...
    {
        // Arrange
        var command = new CreateTemplateCommand("CODE", NotificationChannel.EMAIL, "Subject", invalidBody!);
    ...
    {
        // Arrange
        var command = new CreateTemplateCommand("CODE", (NotificationChannel)999, "Subject", "Body");
