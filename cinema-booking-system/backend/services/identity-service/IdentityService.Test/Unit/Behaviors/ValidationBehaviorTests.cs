...
public class ValidationBehaviorTests
{
    ...
    {
        var behavior = new ValidationBehavior<GetCurrentUserQuery, UserDto>(
        ...
        {
            nextCalled = true;
            return Task.FromResult(new UserDto(1, "kc", "e@e.com", "N", null, null, null, true));
        }
    ...
    public async Task Handle_MultipleValidators_AggregatesAllFailures()
    {
        ...
        var ex = await FluentActions.Invoking(() =>
                behavior.Handle(new GetCurrentUserQuery("kc"), () =>
                    Task.FromResult(new UserDto(1, "k", "e@e.com", "N", null, null, null, true)),
