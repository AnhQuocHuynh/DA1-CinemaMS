...
<@layout.registrationLayout displayMessage=false; section>
    <#if section = "form">
        <main class="flex-grow pt-16 relative overflow-hidden h-screen w-full bg-white dark:bg-slate-950">
            ...
            <div class="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
                ...
                <div class="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-xl shadow-2xl overflow-hidden flex flex-col transform transition-all border border-gray-100 dark:border-slate-800">
                    <div class="p-8 sm:p-10">
                        <div class="mb-10 text-center">
                            <span class="text-xl font-black tracking-tighter text-on-surface block mb-2">
                                ${msg("brandName")}
                            </span>
                            <h1 class="text-2xl font-semibold tracking-tight text-on-surface">${msg("updatePassword")}</h1>
                        ...
                        <form id="kc-passwd-update-form" class="space-y-6" action="${url.loginAction}" method="post">
                            ...
                            <div class="space-y-1.5">
                                <label for="password-new" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">${msg("newPassword")} <span class="text-error">*</span></label>
                                <div class="relative">
