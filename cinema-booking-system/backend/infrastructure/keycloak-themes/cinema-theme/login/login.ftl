                ...
                <div class="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-xl shadow-2xl overflow-hidden flex flex-col transform transition-all border border-gray-100 dark:border-slate-800">
                    <div class="p-8 sm:p-10">
                        ...
                        <div class="mb-10 text-center mt-6">
                            ...
                            <h1 class="text-2xl font-semibold tracking-tight text-on-surface">${msg("welcomeBack")}</h1>
                        ...
                        <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post" class="space-y-6">
                            ...
                            <div class="space-y-1.5">
                                <label for="username" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">${msg("emailAddress")} <span class="text-error">*</span></label>
                                <div class="relative">
                            ...
                            <div class="space-y-1.5">
                                <div class="flex justify-between items-center px-1">
                                    <label for="password" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">
                                        ${msg("password")} <span class="text-error">*</span>
                                    </label>
                        ...
                        <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
                            <div class="mt-8 pt-8 border-t border-outline-variant/30 text-center">
                                <p class="text-sm text-on-surface-variant">
                                    ${msg("dontHaveAccount")}
                                    <a href="${url.registrationUrl}" class="text-primary font-bold hover:underline ml-1">
                                        ${msg("createPortalId")}
                                    </a>
                                </p>
                            </div>
