                ...
                <section class="space-y-8 hidden lg:block">
                    ...
                    <div class="rounded-2xl overflow-hidden border border-outline-variant/40 bg-surface-container-lowest">
                        <div class="relative aspect-[16/9]">
                            ...
                            <div class="absolute bottom-6 left-6">
                                <span class="text-[10px] font-bold uppercase tracking-widest text-primary">
                                    ${msg("priorityOnboarding")}
                                </span>
                                <p class="text-sm text-on-surface mt-2 max-w-sm">
                                    ${msg("priorityOnboardingDesc")}
                                </p>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 p-6">
                            <div class="rounded-xl bg-surface-container-low p-4 border border-outline-variant/30">
                                <div class="text-xl font-semibold tracking-tight text-on-surface">${msg("statSynced")}</div>
                                <div class="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant mt-2">${msg("statSeatHolds")}</div>
                            </div>
                            <div class="rounded-xl bg-surface-container-low p-4 border border-outline-variant/30">
                                <div class="text-xl font-semibold tracking-tight text-on-surface">${msg("statEncrypted")}</div>
                                <div class="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant mt-2">${msg("statTicketVault")}</div>
                            </div>
                            <div class="rounded-xl bg-surface-container-low p-4 border border-outline-variant/30">
                                <div class="text-xl font-semibold tracking-tight text-on-surface">${msg("statTracked")}</div>
                                <div class="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant mt-2">${msg("statRefunds")}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl bg-surface-container-lowest border border-outline-variant/40 p-6">
                        <div class="text-xs font-bold uppercase tracking-[0.2em] text-on-surface-variant">
                            ${msg("bookingPromiseTitle")}
                        </div>
                        <p class="text-sm text-on-surface mt-3">
                            ${msg("bookingPromiseDesc")}
                        </p>
                    </div>
                </section>

                <section class="bg-surface-container-lowest rounded-2xl shadow-2xl border border-outline-variant/40 overflow-hidden bg-white dark:bg-slate-900">
                        ...
                        <form id="kc-register-form" class="space-y-6" action="${url.registrationAction}" method="post">
                            <div class="grid grid-cols-1 gap-6">
                                <div class="space-y-1.5">
                                    <label for="username" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">${msg("username")} <span class="text-error">*</span></label>
                                    <div class="relative">
                                ...
                                <div class="space-y-1.5">
                                    <label for="firstName" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">${msg("firstName")} <span class="text-error">*</span></label>
                                    <div class="relative">
                                ...
                                <div class="space-y-1.5">
                                    <label for="lastName" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">${msg("lastName")} <span class="text-error">*</span></label>
                                    <div class="relative">
                                        <svg class="absolute left-4 top-1/2 -translate-y-1/2 text-outline w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                                ...
                                <div class="space-y-1.5">
                                    <label for="email" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">${msg("emailAddress")} <span class="text-error">*</span></label>
                                    <div class="relative">
                                ...
                                <div class="space-y-1.5">
                                    <label for="phone" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">${msg("phoneNumber")}</label>
                                    <div class="relative">
                            ...
                            <div class="space-y-1.5">
                                <label for="password" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">${msg("password")} <span class="text-error">*</span></label>
                                <div class="relative">
                                ...
                                <p class="text-[11px] text-on-surface-variant px-1">${msg("passwordHint")}</p>
                            </div>

                            <div class="space-y-1.5">
                                <label for="password-confirm" class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">${msg("confirmPassword")} <span class="text-error">*</span></label>
                                <div class="relative">
                                    <svg class="absolute left-4 top-1/2 -translate-y-1/2 text-outline w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                            ...
                            <div class="pt-2 space-y-4">
                                <div class="flex items-center justify-between rounded-lg border border-outline-variant/40 bg-surface-container-low p-4">
                                    <div>
                                        ...
                                        <div class="text-sm font-semibold text-on-surface mt-1">${msg("standardMember")}</div>
                                    </div>
                                    <span class="text-[10px] font-bold uppercase tracking-widest text-primary">
                                        ${msg("ready")}
                                    </span>
                    ...
                    <div class="border-t border-outline-variant/30 px-8 py-6 text-center">
                        ...
                        <p class="text-sm text-on-surface-variant mt-4">
                            ...
                            <a href="${url.loginUrl}" class="text-primary font-bold hover:underline ml-1">
                                ${msg("signIn")}
                            </a>
                        </p>
                    </div>
