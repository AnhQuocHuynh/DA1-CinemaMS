                          ...
                          <div className="flex items-center gap-6">
                            {(
                              ...
                              <div key={role.label} className="flex flex-col items-center gap-1">
                                ...
                                <div
                                  className={`w-8 h-4 rounded-full relative ${role.enabled ? 'bg-blue-600' : 'bg-slate-200'
                                    }`}
                                >
                                  <div
                                    className={`absolute top-0.5 w-3 h-3 bg-white rounded-full ${role.enabled ? 'right-0.5' : 'left-0.5'
                                      }`}
                                  ></div>
                                </div>
                              </div>
