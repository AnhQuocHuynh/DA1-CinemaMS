    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="pt-20 px-6 pb-12 max-w-[1100px] mx-auto">
        <header className="mb-10">
          ...
          <p className="text-slate-600 mt-2">Unlock premium perks and priority access.</p>
        </header>

        <section className="rounded-3xl bg-slate-900 text-white p-10 md:p-14 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            ...
            <Link
              to="/signup"
              className="inline-flex items-center px-6 py-3 rounded-lg bg-blue-600 font-semibold hover:bg-blue-500"
            >
              Start Membership
            </Link>
          </div>
